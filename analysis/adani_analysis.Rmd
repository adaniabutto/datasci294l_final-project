...
# export plot
ggsave((paste0(figures_dir,
               "pct_solved_over_time_perpuzzle.png")),
...
# export plot
ggsave((paste0(figures_dir,
               "no_boxes_over_time_perpuzzle.png")),
...
# export plot
ggsave((paste0(figures_dir,
               "time_spent_solved_over_time.png")),
       width = 12, height = 10, device = "png")
...
# export plot
ggsave((paste0(figures_dir,
               "time_spent_over_time_perpuzzle.png")),
       width = 8, height = 5, device = "png")
...
# export plot
ggsave((paste0(figures_dir,
               "no_moves_over_time_perpuzzle.png")),
       width = 8, height = 5, device = "png")
...
df.analysis %>%
  ...
  labs(x = "Previous puzzle solved?",
       ...
       fill = "Puzzle",
       title = "Puzzle selection by previous puzzle outcome") +
  theme(legend.position = "none")

# export plot
ggsave((paste0(figures_dir,
               "puzzle_selection.png")),
       width = 16, height = 10, device = "png")
...
# export plot
ggsave((paste0(figures_dir,
               "pct_solved_by_prev_success.png")),
       width = 12, height = 10, device = "png")
